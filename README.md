...
```bash
git subtree add --prefix <local-dir> https://github.com/amariwan/<repo> master --squash
git subtree pull --prefix <local-dir> https://github.com/amariwan/<repo> master --squash
git subtree push --prefix <local-dir> https://github.com/amariwan/<repo> master --squash
```
